...
export const actions = {
  ...
  'Feed: comment post':['FEED', 'POST_COMMENT', ['hub_id', 'post_id', 'object_id'],[], {}, 'post_events', 'set object_id to the id of the comment'],
  'Feed: delete post comment':['FEED', 'POST_COMMENT_DELETE', ['hub_id', 'post_id', 'object_id'],[], {}, 'post_events', 'set object_id to the id of the comment'],
  'Feed: post share':['FEED', 'POST_SHARE', ['hub_id', 'post_id', 'object_id', 'network'],[], {'network': 'twitter'}, 'post_events', 'set object_id to the id of the share'],
  'Feed: schedule post share':['FEED', 'POST_SHARE_SCHEDULE', ['hub_id', 'post_id', 'object_id', 'network'],[], {'network': 'twitter'}, 'post_events', 'set object_id to the id of the share'],
